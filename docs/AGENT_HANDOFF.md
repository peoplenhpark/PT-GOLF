...
> **최종 갱신:** 2026-08-06 · **현재 상태:** seed `v22` · SW `ptgolf-v36` · 자산 `?v=36`/`ASSET_VER='36'` · `main` = `origin/main` 동기화됨.
...
- 현재: `version 22`, exercises **32**, principles **9**. PT 칩 순서 = 등 / 팔 / **가슴** / 하체 / 하체 · 머신 / 일일 수행 / 하체 재활 · 일일수행2 / 추천운동 (골프 = 드라이버·아이언).
