...
> **최종 갱신:** 2026-09-04 · **현재 상태:** seed `v32` · SW `ptgolf-v45` · 자산 `?v=45`/`ASSET_VER='45'` · `main` = `origin/main` 동기화됨.
...
- 현재: `version 32`, exercises **45**, principles **10**. PT 칩 순서 = 등 / 팔 / 가슴 / 어깨 / 하체 / 하체 · 머신 / 일일 수행 / 하체 재활 · 일일수행2 / **코어 · 밸런스** (골프 = 드라이버·아이언).
