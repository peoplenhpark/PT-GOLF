...
const ASSETS = [
  ...
  './js/app.js',
  './css/golf.css?v=75',
  './js/golf-data.js?v=75',
  './js/golf.js?v=75',
  './js/exercise-media.js?v=75',
  './media/golf3d/viewer.html?v=75',
  './media/golf3d/lesson.html?v=75',
  './media/golf3d/consistency.html?v=75',
  './media/golf3d/training.html?v=75',
  './media/golf3d/original.html?v=75',
  './media/3d/viewer.html?v=75',
  './media/3d/poses.js?v=75',
  './media/3d/viewer.js?v=75',
  './data/seed.json',
  ...
  './samples/pushdown-3d/combined-start.png?v=75',
  './samples/pushdown-3d/combined-end.png?v=75',
  './samples/pushdown-3d/viewer.html?v=75',
