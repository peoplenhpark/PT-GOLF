...
const ASSETS = [
  ...
  './js/app.js',
  './css/golf.css?v=54',
  './js/golf-data.js?v=54',
  './js/golf.js?v=54',
  './js/exercise-media.js?v=54',
  './media/golf3d/viewer.html?v=54',
  './media/golf3d/viewer.css?v=54',
  './media/golf3d/motion.js?v=54',
  './media/golf3d/poses.js?v=54',
  './media/golf3d/viewer.js?v=54',
  './media/3d/viewer.html?v=54',
  './media/3d/poses.js?v=54',
  './media/3d/viewer.js?v=54',
  './data/seed.json',
  ...
  './samples/pushdown-3d/combined-start.png?v=54',
  './samples/pushdown-3d/combined-end.png?v=54',
  './samples/pushdown-3d/viewer.html?v=54',
