...
const ASSETS = [
  ...
  './js/app.js',
  './css/golf.css?v=84',
  './js/golf-data.js?v=84',
  './js/golf.js?v=84',
  './js/exercise-media.js?v=84',
  './media/golf3d/viewer.html?v=84',
  './media/golf3d/lesson.html?v=84',
  './media/golf3d/consistency.html?v=84',
  './media/golf3d/training.html?v=84',
  './media/golf3d/original.html?v=84',
  './media/3d/viewer.html?v=84',
  './media/3d/poses.js?v=84',
  './media/3d/viewer.js?v=84',
  './data/seed.json',
  ...
  './samples/pushdown-3d/combined-start.png?v=84',
  './samples/pushdown-3d/combined-end.png?v=84',
  './samples/pushdown-3d/viewer.html?v=84',
