...
const ASSETS = [
  ...
  './js/app.js',
  './css/golf.css?v=81',
  './js/golf-data.js?v=81',
  './js/golf.js?v=81',
  './js/exercise-media.js?v=81',
  './media/golf3d/viewer.html?v=81',
  './media/golf3d/lesson.html?v=81',
  './media/golf3d/consistency.html?v=81',
  './media/golf3d/training.html?v=81',
  './media/golf3d/original.html?v=81',
  './media/3d/viewer.html?v=81',
  './media/3d/poses.js?v=81',
  './media/3d/viewer.js?v=81',
  './data/seed.json',
  ...
  './samples/pushdown-3d/combined-start.png?v=81',
  './samples/pushdown-3d/combined-end.png?v=81',
  './samples/pushdown-3d/viewer.html?v=81',
