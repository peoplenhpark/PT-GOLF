...
const ASSETS = [
  ...
  './js/app.js',
  './css/golf.css?v=69',
  './js/golf-data.js?v=69',
  './js/golf.js?v=69',
  './js/exercise-media.js?v=69',
  './media/golf3d/viewer.html?v=69',
  './media/golf3d/lesson.html?v=69',
  './media/golf3d/consistency.html?v=69',
  './media/golf3d/training.html?v=69',
  './media/golf3d/original.html?v=69',
  './media/3d/viewer.html?v=69',
  './media/3d/poses.js?v=69',
  './media/3d/viewer.js?v=69',
  './data/seed.json',
  ...
  './samples/pushdown-3d/combined-start.png?v=69',
  './samples/pushdown-3d/combined-end.png?v=69',
  './samples/pushdown-3d/viewer.html?v=69',
